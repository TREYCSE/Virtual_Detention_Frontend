...
### Phases
##### Phase 1: Deployed application using Tensorflow.js cpu & WebGl backends, Node.js and React.js
* Deploy Natural Language Question Answering with Tensorflow render to user using Node and React/pure Node.js backend w/ bert pretrained functional models w/ React useRef, useState, and useEffect to set the user's input to the model's parameters and render it to the page.
