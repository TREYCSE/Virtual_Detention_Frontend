...
import { NamedTensor, NamedTensorMap } from '@tensorflow/tfjs-core/dist/tensor_types';
import { TypedArray } from '@tensorflow/tfjs-core/dist/types';
import { ModelArtifacts, ModelArtifactsInfo, ModelJSON, WeightGroup, WeightsManifestConfig, WeightsManifestEntry } from '@tensorflow/tfjs-core/dist/io/types';
/**
 ...
 */
export declare function getModelArtifactsForJSONSync(modelJSON: ModelJSON, weightSpecs?: WeightsManifestEntry[], weightData?: ArrayBuffer): ModelArtifacts;
/**
 ...
 * @returns A Promise of the `ModelArtifacts`, as described by the JSON file.
 */
export declare function getModelArtifactsForJSON(modelJSON: ModelJSON, loadWeights: (weightsManifest: WeightsManifestConfig) => Promise<[WeightsManifestEntry[], /* weightData */ ArrayBuffer]>): Promise<ModelArtifacts>;
/**
