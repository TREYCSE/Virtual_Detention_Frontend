...
import { util, ones, scalar, tidy, tensor2d } from '@tensorflow/tfjs-core';
    ...
    BertTokenizer.prototype.loadVocab = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, util.fetch(VOCAB_URL).then(function (d) { return d.json(); })];
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, loadGraphModel(this.modelConfig.modelUrl, { fromTFHub: this.modelConfig.fromTFHub })];
                    case 1:
                        _a.model = _c.sent();
                        batchSize = 1;
                        inputIds = ones([batchSize, INPUT_SIZE], 'int32');
                        segmentIds = ones([1, INPUT_SIZE], 'int32');
                        inputMask = ones([1, INPUT_SIZE], 'int32');
                        this.model.execute({
                            input_ids: inputIds,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        globalStep = scalar(1, 'int32');
                        batchSize = features.length;
                        result = tidy(function () {
                            var inputIds = tensor2d(inputIdArray, [batchSize, INPUT_SIZE], 'int32');
                            var segmentIds = tensor2d(segmentIdArray, [batchSize, INPUT_SIZE], 'int32');
                            var inputMask = tensor2d(inputMaskArray, [batchSize, INPUT_SIZE], 'int32');
